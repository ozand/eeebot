...
init_state() {
  ...
  for subdir in reports subagents/requests subagents/results improvements approvals goals outbox subagent_bridge workspace/subagents validator_harness usage curator action_index reflector strategist; do
